...
const BARRE_MOBILE = ['dashboard', 'temperatures', 'checklists', 'nonconformities', 'compte'];
const LIBELLES_COURTS = { dashboard: 'Tableau', temperatures: 'Relevés', checklists: 'Routine', nonconformities: 'Alertes', compte: 'Compte' };
